...
IF NOT (DEFINED KSP_MCP_SAFETY_INIT) {
  ...
  WHEN NOT HOMECONNECTION:ISCONNECTED THEN { KSP_MCP_RELEASE(). IF NOT KSP_MCP_SIGNAL_LOST { SET KSP_MCP_SIGNAL_LOST TO TRUE. PRINT "[ksp-mcp] Signal lost - controls released.". } PRESERVE. }
  WHEN HOMECONNECTION:ISCONNECTED THEN { IF KSP_MCP_SIGNAL_LOST { SET KSP_MCP_SIGNAL_LOST TO FALSE. PRINT "[ksp-mcp] Signal restored.". } PRESERVE. }
